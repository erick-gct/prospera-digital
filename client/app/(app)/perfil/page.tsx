...
export default function ProfilePage() {
  ...
  const fetchProfile = async () => {
    try {
      ...
      // Determinar el rol: localStorage primero, luego BD
      let role =
      ...
      if (!role) {
        // Verificar en BD si no está en localStorage
      ...
      // Si es administrador, no tiene perfil de paciente/podologo
      if (role === "ADMINISTRADOR") {
        // Crear un perfil básico para el admin
        ...
        if (adminData) {
          setProfile({
            ...
            nombres: adminData.nombres || "Administrador",
            apellidos: "",
            cedula: "",
            email: adminData.email || user.email || "",
            telefono: null,
            fecha_nacimiento: null,
            fecha_creacion: adminData.fecha_creacion,
            fecha_modificacion: adminData.fecha_modificacion,
          } as Paciente);
        }
        setIsLoading(false);
        return;
  ...
  if (isLoading && !profile) {
    // Solo mostrar loader si no hay datos aún
    return (
            ...
            <div>
              ...
              <div className="flex items-center gap-2 mt-1">
                ...
                {isPaciente && (
                  <Badge
                    variant={
                      pacienteData?.estado_paciente_id === 1
                        ? "default"
                        : "destructive"
                    }
                    className="text-xs"
        ...
        <div className="p-6 grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <InfoItem
                ...
                value={
                  profile.fecha_nacimiento
                    ? format(new Date(profile.fecha_nacimiento), "PPP", {
                        locale: es,
                      })
                    : "No registrada"
                }
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <InfoItem
                label="País"
                value={profile.paises?.nombre || "No registrado"}
                icon={MapPin}
              />
              {isPaciente && (
                <InfoItem
              ...
              <>
                ...
                <div className="grid gap-3">
                  ...
                  <div className="bg-gray-50 p-3 rounded-md border border-gray-100">
                    ...
                    <p
                      className="text-sm mt-1 text-gray-700 leading-relaxed line-clamp-3"
                      title={pacienteData?.enfermedades || ""}
                    >
              ...
              <div className="bg-muted/30 p-3 rounded-lg border flex justify-between items-center">
                ...
                <span className="text-sm font-medium">
                  {profile.fecha_creacion
                    ? format(new Date(profile.fecha_creacion), "PPpp", {
                        locale: es,
                      })
                    : "-"}
                </span>
              ...
              <div className="bg-muted/30 p-3 rounded-lg border flex justify-between items-center">
                ...
                <span className="text-sm font-medium">
                  {profile.fecha_modificacion
                    ? format(new Date(profile.fecha_modificacion), "PPpp", {
                        locale: es,
                      })
                    : "Sin modificaciones"}
                </span>
